...
function PriceCard({ data }) {
  //   return (
  //     <div
  //       className={`sm:min-w-96 max-w-2xs  rounded-2xl shadow-sm hover:shadow-2xl transition duration-100 px-8  relative space-y-4 border border-[#ddd] py-5 ${data.tag ? "bg-linear-to-r from-[#4f39f6] to-[#9514fa] text-white " : "bg-transparent"}  `}
  //     >
  //       {data.tag && (
  //         <p
  //           className={`absolute inline-flex -top-2 left-[35%] capitalize bg-yellow-500 text-yellow-600 font-semibold py-0.5 px-2 rounded-full `}
  //         >
  //           {data.tag}{" "}
  //         </p>
  //       )}
  ...
  //       </h2>
  //       <p
  //         className={`${data.tag ? " text-white " : "text-[#627382]"}  font-normal loading-[1.112px]`}
  //       >
  //         {data.desc}
  //       </p>
  ...
  //           <li
  //             className={`${data.tag ? " text-white " : "text-[#627382]"}  font-normal loading-[1.112px] flex items-center justify-center`}
  //             key={i}
  //           >
  ...
  //       <button
  //         className={`
  //     capitalize rounded-3xl btn w-full font-bold hover:scale-95 transition duration-100 border-none
  //     ${
  //       data.tag
  //         ? "bg-white bg-linear-to-r from-[#4f39f6] to-[#9514fa] bg-clip-text text-transparent"
